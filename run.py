...
from dataprocess.data_processor import ERTESDDataProcessor
from dataprocess.dataset import ERTESDDataset, ERTESDSpanDataset
from model.model_transformers import  ERTESDModel
...
DataProcessorDict = {
    "ERTESD_span": ERTESDDataProcessor
}

DatasetDict = {
    "ERTESD_span": ERTESDSpanDataset 
}

ModelDict = {
    "ERTESD_span": ERTESDModel
}
...
DataMetricDict = {
    "ERTESD_span": ERTESD_span_metric
}
...
DataExtractDict = {
    "ERTESD_span": ERTESD_span_extractor
}

LableNamesDict = {
    "ERTESD_span":["head_label", "tail_label", "span_label"],
}
...
class RunArguments:
    ...
    test_data_type: str = field(
        metadata={"help": "Which data type to test"},
        default=None)
...
if __name__ == '__main__':
    ...
    added_token = [f"[unused{i}]" for i in range(1, 99)]
    ...
    if run_args.do_test_all_checkpoints:
        ...
        ExtractType(tokenizer, test_dataset, test_prediction, output_dir, reevmode = True)
